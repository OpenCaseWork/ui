...
export class ProgramsComponent implements OnChanges {
  ...
  constructor(private logService: LogService,
    ...
    console.log('ProgramsComponent.constructor');
  }
  ...
  ngOnChanges() {
    ...
    */
    this.logService.log('ProgramsComponent.ngOnChanges');
  }
